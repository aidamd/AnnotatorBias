...
Annotators_Love_Mohammad_2 <- read_csv("/home/aida/Projects/Stereotype/Data/Annotators_Love_Mohammad_after_final_cleaning.csv")

cols.num <- c("ResponseId", "SD_immigrant_1", "SD_immigrant_2", "SD_immigrant_3", "SD_immigrant_4",
              "SD_muslim_1", "SD_muslim_2", "SD_muslim_3", "SD_muslim_4",
              "SD_communist_1", "SD_communist_2", "SD_communist_3", "SD_communist_4",
              "SD_liberal_1", "SD_liberal_2", "SD_liberal_3", "SD_liberal_4",
              "SD_black_1", "SD_black_2", "SD_black_3", "SD_black_4",
              "SD_gay_1", "SD_gay_2", "SD_gay_3", "SD_gay_4",
              "SD_jewish_1", "SD_jewish_2", "SD_jewish_3", "SD_jewish_4",
              "SD_woman_1", "SD_woman_2", "SD_woman_3", "SD_woman_4",
              "Immigrant_1", "Immigrant_2", "Immigrant_3", "Immigrant_4", "Immigrant_5", "Immigrant_6", "Immigrant_7",
              ...
              "conservatism", "republican", "Hate_Speech_intro",
              "annualincome", "socialclass", "job_1", "job_2", "job_3", "supervisingjob",
              "age", "sex", "sexualorientation", "religion", "religiosity_1", "race"
              )
Annotators_Love_Mohammad_2[cols.num] <- sapply(Annotators_Love_Mohammad_2[cols.num],as.numeric)
...
subset_black = Annotators_Love_Mohammad_2%>%
  ...
  dplyr::select(StartDate:LS,newnames)
...
dat = dplyr::bind_rows(subset_black,subset_communist,subset_gay,subset_jewish,
  ...
  dplyr::filter(Hate_Speech_intro == 1)%>%
  ...
  dplyr::mutate(SD_immigrant_tot = SD_immigrant_1 + SD_immigrant_2 + SD_immigrant_3 +SD_immigrant_4,
                ...
                ##
                SD_immigrant_competent = SD_immigrant_4,
                SD_muslim_competent = SD_muslim_4,
                SD_communist_competent = SD_communist_4,
                SD_liberal_competent = SD_liberal_4,
                SD_black_competent = SD_black_4,
                SD_gay_competent = SD_gay_4,
                SD_jewish_competent = SD_jewish_4,
                SD_woman_competent = SD_woman_4,
                ##
                SD_immigrant_warm = (SD_immigrant_2 + SD_immigrant_3 +SD_immigrant_1) / 3,
                SD_muslim_warm = (SD_muslim_2 + SD_muslim_3 + SD_muslim_1) / 3,
                SD_communist_warm = (SD_communist_2 + SD_communist_3 + SD_communist_1) / 3,
                SD_liberal_warm = (SD_liberal_2 + SD_liberal_3 + SD_liberal_1) / 3,
                SD_black_warm = (SD_black_2 + SD_black_3 + SD_black_1) / 3,
                SD_gay_warm = (SD_gay_2 + SD_gay_3 + SD_gay_1) / 3,
                SD_jewish_warm = (SD_jewish_2 + SD_jewish_3 + SD_jewish_1) / 3,
                SD_woman_warm = (SD_woman_2 + SD_woman_3 + SD_woman_1) / 3,
                ##
  ...
  dplyr::select(SGT, starts_with("SD_"), ends_with("tot"),ends_with("warm"),ends_with("competent"),age,sex,sexualorientation,religion,religiosity_1,race,race_white,starts_with("Q"),
                Immigrant_1,Immigrant_2,Immigrant_3,Immigrant_4,Immigrant_5,Immigrant_6,Immigrant_7,
                Muslim_1,Muslim_2,Muslim_3,Muslim_4,Muslim_5,Muslim_6,Muslim_7,
                Communist_1,Communist_2,Communist_3,Communist_4,Communist_5,Communist_6,Communist_7,
                Liberal_1,Liberal_2,Liberal_3,Liberal_4,Liberal_5,Liberal_6,Liberal_7,
                ...
                Gay_1,Gay_2,Gay_3,Gay_4,Gay_5,Gay_6,Gay_7,
                Jew_1,Jew_2,Jew_3,Jew_4,Jew_5,Jew_6,Jew_7,
                Woman_1,Woman_2,Woman_3,Woman_4,Woman_5,Woman_6,Woman_7, ResponseId)
...
dat$Immigrant_1 <- dat$Immigrant_1 - 1
write.csv(dat, "/home/aida/Projects/Stereotype/Data/survey_cleaned.csv")
